...
module.exports = {
    ...
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'Engeneyund Toxic-Alexa🌝' : process.env.ALIVE_BUTTON,
    ...
    BC: process.env.BROADCAST_NAME === undefined ? 'ɪ̄.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ ᴀʟᴇxᴀꫂ⁩' : process.env.BROADCAST_NAME,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Alinshan' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Toxic-Alexa' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919383491460@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://www.linkpicture.com/q/Toxic-Alexa.jpg' : process.env.LG_LOGO,
    ...
    ABU: process.env.ABU_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴛᴏxɪᴄ ᴀʟᴇxᴀ' : process.env.ABU_CAPTION,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.linkpicture.com/q/Toxic-Alexa.jpg' : process.env.ALL_IMG,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'ᴛᴏxɪᴄ ᴀʟᴇxᴀ💞/💝/✨/📝' : process.env.CMD_LIST,
